...
<div id="EditUserModal" class="modal modal-edu-general default-popup-PrimaryModal PrimaryModal-bgcolor fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-close-area modal-close-df">
                <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
            ...
            <div class="modal-body">
              <!--  <i class="educate-icon educate-checked modal-check-pro"></i>-->
                <h2 style="font-size: 1rem;">Alterar Registo de Utilizador</h2>
                <div class="row">
                    <form action = "{{url('/user/registar')}}"  method="Post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <input name="name" value="{{$user[0]->name}}" type="text" class="form-control" placeholder="Nome">
                        </div>
                        <div class="form-group">
                            <input name="email"  value="{{$user[0]->email}}" type="email" class="form-control" placeholder="Seu Email">
                        </div>

                        <div class="form-group">
                            <select name="permission" class="form-control">
                                    <option value="{{$user[0]->permicao}}" >{{$user[0]->permicao}}</option>
                                    <option value="Bibliotecário">Bibliotecário</option>
                                    <option value="Docente/Pesquisador
                                    ">Docente ou Pesquisador</option>
                                    <option value="Estudante">Estudante</option>
